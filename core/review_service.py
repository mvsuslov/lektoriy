...
- 10 ставь, только если существенных недочётов нет, а оставшиеся предложения —
  необязательные улучшения «на вырост». Не бойся десятки за эталонную работу,
  но и не раздавай её за «просто хороший» текст.
- Если существенных недочётов нет — weaknesses может быть пустым списком.
- suggestions — самое ценное: давай конкретные правки, а не общие слова.
  Если текст почти идеален — честно укажи 1-2 необязательных улучшения,
